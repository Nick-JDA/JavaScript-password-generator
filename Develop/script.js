...
//--------------------------------------------------used for frist and second attempts located below----------------------------------------------------------------------------------------
...
function generatePassword() { 
  ...
  var password = "";                                                                //setting password value as empty string to be filled
  var phArray = [];                                                                 //set empty array so values can be inserted dependent on users input
  

  if (numCon == true) {                                                             //if statement for when number is true 
    phArray = phArray.concat(numOpt);                                               //combines the empty array with the number array values
  }


  if (speCon == true) {                                                             //if statement for when special character is true
    phArray = phArray.concat(specOpt);                                              //combines the empty array with the special character array values
  }


  if (bigCase == true) {                                                            //if statement for when upper case is true
    phArray = phArray.concat(uppCase);                                              //combines the empty array with the upper case array values
  }


  if (smolCase == true) {                                                           //if statement for when lower case is true
    phArray = phArray.concat(lowCase);                                              //combines the empty array with the lower case array values
  }

  for (var x = 0; x < length; x++) {                                                //for loop that runs until "x" in this case reaches user set password length
    var pwLng = Math.floor(Math.random() * phArray.length);                         //making a variable called "pwLng" and setting it to equal the randomizer
    password = password + phArray[pwLng];                                           //sets password to equal password plus the phArray and pwLng combination
  }




//-----------------------------------------------------------------------------------------------Second attempt that worked but not completely------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------first attempt that gave birth to second attempt------------------------------------------------------------------------------------------------------------------------------- 
